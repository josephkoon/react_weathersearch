		...
		return (
			<div>
				...
				<ul className='list-group'>
					...
					<li className='list-group-item'><strong>Relative Humidity: </strong>{this.props.weather.current_observation.wind_string}</li>
					<li className='list-group-item'><strong>Relative Humidity: </strong>{this.props.weather.current_observation.dewpoint_string}</li>
				</ul>
			</div>
		)
	}
